...
public class BaseOptionsGump : Gump
{
    ...
    protected class ComboBoxWithLabel : Control, SearchableOption
    {
        ...
        private class Combobox : Control
        {
            ...
            public Combobox(World world, int width, string[] items, int selected = -1, int maxHeight = 200, Action<int, string> onOptionSelected = null)
            {
                this.world = world;
                Width = width;
                Height = 25;
            ...
            protected override void OnMouseUp(int x, int y, MouseButtonType button)
            {
                ...
                UIManager.Add(new ComboboxGump(world, ScreenCoordinateX, comboY, Width, _maxHeight, _items, this));
            ...
            private class ComboboxGump : Gump
            {
                ...
                public ComboboxGump(World world, int x, int y, int width, int maxHeight, string[] items, Combobox combobox) : base(world, 0, 0)
                {
                    CanMove = false;
                    AcceptMouseInput = true;
                    X = x;
